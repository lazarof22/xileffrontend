            ...
            <Box sx={{ display: 'flex', ml: 2 }}>
                <Card sx={{ width: 'auto', display: 'inline-flex', m: 2 }}>
                    <CardContent sx={{ py: 2, px: 3 }}>
                        <Typography variant="h6"><MonetizationOnIcon fontSize='large' sx={{ mr: 1 }} />
                            Ventas del Mes:
                        </Typography>
                ...
                <Card sx={{ width: 'auto', display: 'inline-flex', m: 2 }}>
                    <CardContent>
                        <Typography variant="h6">
                            <InventoryIcon fontSize='large' sx={{ mr: 1 }} />Productos en Stock:
                        </Typography>
                        <Typography variant="h4" color='primary' sx={{ textAlign: 'center' }}>
                            320
                        </Typography>
                ...
                <Card sx={{ width: 'auto', display: 'inline-flex', m: 2 }}>
                    <CardContent>
                        <Typography variant="h6"><SupervisedUserCircleIcon fontSize='large' sx={{ mr: 1 }} />
                            Clientes Activos:
                        </Typography>
                        <Typography variant="h4" color='primary' sx={{ textAlign: 'center' }}>
                            4
                ...
                <Card sx={{ width: 'auto', display: 'inline-flex', m: 2 }}>
                    <CardContent>
                        <Typography variant="h6"><WcIcon fontSize='large' sx={{ mr: 1 }} />
                            Empleados:
                        </Typography>
                        <Typography variant="h4" color='primary' sx={{ textAlign: 'center' }}>
                            6
