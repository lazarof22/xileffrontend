    ...
    return (
      <div>
        ...
        {/* ═══════════════════════════════════════════════════════════════
           ...
           ═══════════════════════════════════════════════════════════════ */}
        {tabValue === 1 && (
          <Box sx={{ m: 2, display: "flex", flexDirection: "column", gap: 2, alignItems: "center" }}>
            {/* ── Fila superior: Registrar + Resumen ──────────────────── */}
            <Box
              sx={{
                display: "flex",
                gap: 2,
            ...
            {/* ═══════════════════════════════════════════════════════════
                TABLA DE CxC (debajo de los dos Box)
               ═══════════════════════════════════════════════════════════ */}
            <Card
              sx={{
                width: "100%",
        ...
        {/* ═══════════════════════════════════════════════════════════════
            CONTENIDO: TAB 3+ — Placeholders
           ═══════════════════════════════════════════════════════════════ */}
        {tabValue >= 3 && (
          <Card sx={{ m: 2, p: 4, borderRadius: 2, textAlign: "center" }}>
            <Typography variant="h6" color="text.secondary">
              {["Cuentas por Pagar", "Banco", "Créditos", "Anticipos", "Presupuesto", "Reportes", "Configuración"][tabValue - 3] || "Módulo en desarrollo"}
            </Typography>
