...
const ESTADOS_ANTICIPO = [
  ...
  const handleDeleteAnticipo = async (id: string) => {
    ...
    // ── FETCH HELPERS COBROS (OBLIGACIONES) ───────────────────────────
  ...
  if (tabValue === 4) setOpenMovimientoBancoDialog(true);
            ...
            >
              {tabValue === 0 ? "Nueva Transacción" : tabValue === 4 ? "Nuevo Movimiento" : tabValue === 3 ? "Nueva Transacción":""}
            </Button>
            <Button
              variant="contained"
          ...
          <Box sx={{ m: 2, display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            {bancoSubTab === 1 && (
              <Card sx={{ p: 2, borderRadius: 2 }}>
                ...
                {/* ═══════════════════════════════════════════════════════════════
            CONTENIDO: TAB 3 — COBROS (OBLIGACIONES)
           ═══════════════════════════════════════════════════════════════ */}
        {tabValue === 3 && (
          <Box sx={{ m: 2, display: "flex", flexDirection: "column", gap: 2 }}>
            {/* ═══════════════════════════════════════════════════════
      ...
      >
        ...
        <DialogActions>
          ...
          >
            ...
            {/* ═══════════════════════════════════════════════════════════════
          DIÁLOGOS DE COBROS (OBLIGACIONES)
         ═══════════════════════════════════════════════════════════════ */}
